...
<head>
  <meta charset="UTF-8" />
  <title>Reset Password | AMS Training Portal</title>
  ...
  <style>
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    ...
    .btn-primary{
      ...
      box-shadow:0 1px 3px oklch(0.3 0.08 192/.35);
...
(function () {
  ...
  if (!user) {
    sessionStorage.setItem("ams_notice", "Please log in first.");
...
<div class="page">
  <div class="auth-card">
    ...
    <p class="card-sub">Choose a strong new password for your AMS account.</p>
...
<!-- MSG HELPER (used by reset-password.js if needed) -->
<script>
