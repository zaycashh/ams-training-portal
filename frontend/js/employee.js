/* =========================================================
   ...
   HYBRID ACCESS (Company Seats + Individual Purchase)
========================================================= */
...
const EMPLOYEE_CONTENT_DONE_KEY = `employeeContentCompleted_${USER_EMAIL}`;
const EMPLOYEE_PASSED_KEY = `employeeQuizPassed_${USER_EMAIL}`;
const EMPLOYEE_COMPLETED_KEY = `employeeTrainingCompleted_${USER_EMAIL}`;
const EMPLOYEE_ATTEMPTS_KEY = `employeeQuizAttempts_${USER_EMAIL}`;
const EMPLOYEE_COOLDOWN_KEY = `employeeQuizCooldownUntil_${USER_EMAIL}`;
const EMPLOYEE_CERT_CODE_KEY = `employeeCertificateCode_${USER_EMAIL}`;
...
localStorage.getItem(EMPLOYEE_ATTEMPTS_KEY)||"0",10
)+1;
